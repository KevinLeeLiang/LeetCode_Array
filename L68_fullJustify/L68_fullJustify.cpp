...
#include "L68_fullJustify.h"

string L68_fullJustify::join(vector<string> &words, int left, int right, string sep) {
    string s = words[left];
...
string L68_fullJustify::blank(int n) {
    return string(n, ' ');
}

vector<string> L68_fullJustify::fullJustify(vector<string> &words, int maxWidth) {
    vector<string> ans;
